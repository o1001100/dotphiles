...
document.querySelectorAll('.close-btn').forEach((elem) => {elem.addEventListener('click', (e) => {
...
document.querySelectorAll('#signout, .store-container .signout-btn').forEach((elem) => {elem.addEventListener('click', (e) => {
    Auth.logout().then(() => {
        document.location.reload();
    });
});});
document.querySelectorAll('#ladderboard, #mltpl_ladders').forEach((elem) => {elem.addEventListener('click', (e) => {
...
document.querySelectorAll('#google_sign_in, #header_signin, #content_signin, #leaderboard_signin').forEach((elem) => {elem.addEventListener('click', (e) => {
    chrome.permissions.request({
...
document.querySelectorAll('#shop_btn, #night_mode_promo .store-btn').forEach((el) => {el.addEventListener('click', (e) => {
    game.changeModal(MODAL.NONE);
    if (Auth.logged_as) {
        game.showModalShop();
    } else {
...
document.querySelectorAll('.close_shop_btn').forEach((el) => {el.addEventListener('click', (e) => {
    game.screenPool.pop();
    game.changeScreen(game.screenPool.pop());
});});
