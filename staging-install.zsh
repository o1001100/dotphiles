...
local rsh=(false)
local dots=$(pwd)
if [[ ($distro = debian) ]]; then local pkgman='sudo apt install'

function install_git () {
  print "Git doesn't appear to be installed, would you like me to install it for you? (Y/n)"
  read -sq place
  if [[ ($place = 'y') ]]
    print 'Okay, installing Git'
